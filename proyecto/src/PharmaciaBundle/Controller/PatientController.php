...
class PatientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $patients = $em->getRepository('PharmaciaBundle:Patient')->findAll();
    ...
    {
        $patient = new Patient();
        $form = $this->createForm('PharmaciaBundle\Form\PatientType', $patient);
    ...
    {
        $deleteForm = $this->createDeleteForm($patient);
        $editForm = $this->createForm('PharmaciaBundle\Form\PatientType', $patient);
